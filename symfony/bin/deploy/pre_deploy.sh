...
docker exec -e DATABASE_URL=$DATABASER_URL container_phpfpm bin/console doctrine:database:create
docker exec -e DATABASE_URL=$DATABASER_URL container_phpfpm bin/console doctrine:migrations:migrate --no-interaction
